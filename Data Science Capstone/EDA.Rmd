...
```{r read.files, message=FALSE, cache=FALSE, include=FALSE}
library(readr)
...
```{r ntok, message=FALSE, warning=FALSE, include=FALSE, cache = TRUE}
library(dplyr)
library(quanteda)
library(tokenizers)
library(stopwords)
...
```{r ntok.boxplot, echo=FALSE, message=FALSE, warning=FALSE}
...
Raw texts:
```{r raw.fivenum, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r stopwords.fivenum, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r unique.ntok.boxplot, echo=FALSE, message=FALSE, warning=FALSE}
# Boxplots: partition overview
...
```{r ngrams, message=FALSE, warning=FALSE, cache=TRUE, include=FALSE}
# Get all bigrams
...
```{r bigram.plot, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r bigram.sumary, echo=FALSE, message=FALSE, warning=FALSE}
